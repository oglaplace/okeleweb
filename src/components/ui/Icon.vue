...
const PATHS = {
  ...
  /*
   * The shackle SPRUNG, not merely missing a leg.
   *
   * The first version was the padlock minus its right upright, which at 13px
   * is one 3.5-unit stroke of difference — two states of the same control that
   * nobody could tell apart at a glance. Here the hook lifts off the body
   * entirely and swings clear to the right, so "open" is a shape, not a
   * detail: the marks under this header can be typed into.
   */
  lockOpen: "M6 10.5h12v10H6zM9 10.5V7a4 4 0 0 1 7.9-.8",
